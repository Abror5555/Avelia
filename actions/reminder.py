...
try:
    ...
    notification.notify(title="A.V.E.L.I.A Reminder", message=message, timeout=15)
    notified = True
except Exception:
    pass
...
if not notified:
    try:
        ...
        ToastNotifier().show_toast("A.V.E.L.I.A Reminder", message, duration=15, threaded=False)
        notified = True
    except Exception:
        pass
...
if not notified:
    try:
        import subprocess
        script = 'display notification "{{}}" with title "A.V.E.L.I.A Reminder"'.format(
            message.replace('"', '')
        )
...
"""
    ...
    script_body = f"""# Auto-generated by A.V.E.L.I.A reminder — do not edit
...
def _schedule_windows(target_dt: datetime, task_name: str,
    ...
    xml_content = (
        ...
        '  <RegistrationInfo><Description>A.V.E.L.I.A Reminder</Description></RegistrationInfo>\n'
...
def _schedule_mac(target_dt: datetime, task_name: str,
    ...
    label     = f"com.avelia.reminder.{task_name}"
...
def reminder(
    ...
    task_name  = f"AVELIAReminder_{target_dt.strftime('%Y%m%d_%H%M%S')}"
