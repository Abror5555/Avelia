...
Two things it deliberately does NOT install:
  * the optional local wake word ("Hey Avelia") — one-click, opt-in, from
...
def _check_python() -> None:
    ...
    if v > MAX_PY:
        ...
        return
    if v < MIN_PY:
        print(f"\n❌ Python {v[0]}.{v[1]} detected — AVELIA needs at "
...
def main() -> None:
    print(f"⚙  AVELIA setup — detected OS: {OS or 'unknown'}, "
    ...
    print("   3) (Optional) Enable 'Hey Avelia' from ⚙ → WAKE WORD.")
