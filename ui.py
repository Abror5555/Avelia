    ...
    def paintEvent(self, _):
        ...
        if self._face_px:
            ...
            p.drawText(QRectF(cx - 80, cy - 14, 160, 28),
                       Qt.AlignmentFlag.AlignCenter, "A.V.E.L.I.A")
...
class LogWidget(QTextEdit):
    ...
    def _next(self):
        ...
        elif tl.startswith("avelia:"): self._tag = "ai"
...
class SetupOverlay(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        layout.addWidget(_lbl("Configure A.V.E.L.I.A. before first boot.", 9, color=C.PRI_DIM))
        layout.addSpacing(6)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        ...
        self.setWindowTitle("A.V.E.L.I.A — ABROR")
    ...
    def _create_lnk_windows(lnk: str, target: str, args: str,
        ...
        try:
            ...
            sc.Description      = "A.V.E.L.I.A AI Assistant"
    ...
    def _create_desktop_shortcut(self):
        ...
        try:
            ...
            if _os == "Windows":
                ...
                lnk      = str(desktop / "A.V.E.L.I.A.lnk")
            ...
            # ── macOS — proper .app bundle (no Terminal window) ───────────────
                ...
                (app / "Contents" / "Info.plist").write_text(
                    ...
                    '  <key>CFBundleName</key><string>A.V.E.L.I.A</string>\n'
            ...
            # ── Linux — .desktop file (Terminal=false, no console) ────────────
                ...
                desk = desktop / "A.V.E.L.I.A.desktop"
                desk.write_text(
                    "[Desktop Entry]\n"
                    "Name=A.V.E.L.I.A\n"
                    f"Exec={python} {script}\n"
    ...
    def _build_header(self) -> QWidget:
        ...
        lay.addWidget(_badge("ABROR", C.PRI_DIM))
        lay.addStretch()

        mid = QVBoxLayout(); mid.setSpacing(1)
        title = QLabel("A.V.E.L.I.A")
    ...
    def _build_footer(self) -> QWidget:
        ...
        lay.addStretch()
        lay.addWidget(_fl("ABROR Industries  ·  CLASSIFIED"))
        lay.addStretch()
        lay.addWidget(_fl("© ABROR", C.PRI_DIM))
        return w
    ...
    def _on_file_selected(self, path: str):
        ...
        self._file_hint.setText(f"{icon}  {p.name}  ·  {size}  ·  Tell AVELIA what to do with it")
    ...
    def _on_setup_done(self, key: str, os_name: str):
        ...
        if self._overlay:
            ...
            self._overlay = None
        self._apply_state("LISTENING")
        self._log.append_log(f"SYS: Initialised. OS={os_name.upper()}. AVELIA online.")
