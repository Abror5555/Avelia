"""
core/audio_devices.py — pick which microphone and which speakers AVELIA uses.
...
WHY
    ...
    "AVELIA can't hear me" almost always means "AVELIA is listening to the
...
WHY THIS IS CACHED
    ...
    milliseconds on a Windows machine with many endpoints. A past release learned this
